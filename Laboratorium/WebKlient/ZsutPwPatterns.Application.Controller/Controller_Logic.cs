...
namespace ZsutPw.Patterns.Application.Controller
{
  ...
  public partial class Controller : IController
  {
    ...
    private ApplicationState currentState = ApplicationState.List;
        ...
        public ICommand SearchDoctorRoomCommand { get; private set; }

        public ICommand ShowListCommand { get; private set; }

    public ICommand ShowMapCommand { get; private set; }

        private void SearchDoctorRoom()
        {
            this.Model.LoadPairList();
        }
        public async Task SearchDoctorRoomAsync()
        {
            await Task.Run(() => this.SearchDoctorRoom());
        }
